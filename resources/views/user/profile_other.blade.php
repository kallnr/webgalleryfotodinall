...
@section('content')
    ...
    <section>
        <div class="flex flex-col items-center max-w-screen-md px-2 mx-auto mt-7">
            <div>
                <img src="/pic/{{$dataprofile->foto_profil }}"
    ...
    <!-- Tabs Menu -->
    <div class="mb-4 max-w-screen-md mx-auto border-gray-200 dark:border-gray-700 sm:pl-[40px]">
    ...
    <div id="default-tab-content">
        ...
        <div class="hidden p-4 rounded-lg mb-14" id="album" role="tabpanel" aria-labelledby="album-tab">
            ...
            <div class="max-w-screen-md mx-auto grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div>
                    <a href="/album/"><img class="h-auto max-w-full rounded-lg" src="/assets/album.png" alt=""></a>
                    <div class="mt-2">
