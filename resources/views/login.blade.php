...
<body class="bg-slate-300">
    ...
    <nav class="fixed top-0 z-20 w-full text-black bg-white shadow-md">
        <div class="flex items-center justify-between max-w-screen-md mx-auto">
            ...
            <h2 class="ps-3 text-black text-3xl font-telex">Gallify</h2>
        </div>
        <div>
           
        <button  class="px-4 text-white bg-blue-700 rounded-full font-telex transition duration-500 ease-in-out hover:scale-105"><a href="/register">Register</a></button>
        ...
        <section class="mt-70">
            <div class="max-w-[364px] bg-gray-100 shadow-2xl mx-auto px-6 py-4 rounded-3xl">
                <div class="flex flex-col">
                    <br>
                    <h3 class="mx-auto text-3xl font-telex">Gallify</h3>
                ...
                <button type="submit" class="py-1 mt-4 mx-5 text-center text-white rounded-full bg-blue-700 font-telex  transition duration-500 ease-in-out hover:scale-105">Login</button>
                <hr class="mt-4 mx-3">
